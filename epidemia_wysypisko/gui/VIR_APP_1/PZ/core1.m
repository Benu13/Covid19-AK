...
global chances;
chances = [0 0.1; 0.05 0.01; 0.5 0; 0 0.15; 0.6 0; 0.3 0; 0 0; 0 0];
chances = chances*1;
% bazowe prawdopodobienstwa zarazenie siebie i innych

global reform_times_and_efficiency;
reform_times_and_efficiency = [1 11 18 20 23 30 40; 0.03 0.035 0.04 0.045 0.05 0.06 0.075];
global prob;
prob.F = 0;             % healthy przechodzi na in_quarantine
