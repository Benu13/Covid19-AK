function [pop_struct_out,omm,nmm] = Moirai_thread(pop_struct,x_inf,y_inf,no_symp)
...
for i = 1:length(x_inf') 
    ...
    if rand_temp < pop_struct_s(x_inf(i),y_inf(i),3) && pop_struct_s(x_inf(i),y_inf(i),1) ~= 9 && pop_struct_s(x_inf(i),y_inf(i),1) ~= 4
