...
random_spawn_when_open_border = 1; %SET ON ONE TO GET RANDOM INFECTED WHEN COUNTRY IS NOT ON LOCKDOWN
...
for day = 1:SIMULATION_TIME
    ...
    if live_plots == 1
        ...
        title('Confirmed cases'); %ppl in hospital and ppl with symptoms
        drawnow;
%         subplot(3,4,3)
%         a = a+c;
%         inf_gr_sum = [inf_gr_sum  a];
